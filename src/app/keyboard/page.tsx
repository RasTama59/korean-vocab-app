...
export default function KeyboardPage() {
  ...
  const isCorrect =
    input.trim().length > 0 && input.trim() === currentWord.word.trim()
    ...
    <main className={styles.page}>
      <div className={styles.card}>
        ...
        <div className={styles.quizBox}>
          ...
          {isCorrect && (
            <p className={styles.correct}>正解です！ 次の問題へ進みます…</p>
          )}
        </div>
            ...
            <div className={styles.keyRow}>
              ...
              {KEY_ROWS[0].map((item) => (
                ...
                >
                  ...
                  {item.shiftHangul && (
                    <span className={styles.keyShiftHint}>
                      Shift: {item.shiftHangul}
                    </span>
                  )}
                </div>
              ))}
